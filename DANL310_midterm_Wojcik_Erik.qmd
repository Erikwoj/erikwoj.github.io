...
# Europe and Oceania seem to have a higher life expectancy in 2007
...
# The number of tweets involving climate change has increased worldwide as well in the United States between 2012-2017. This can also be said with the retweets and likes.
...
a<-ggplot(data = stock, aes(company ='AMZN' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
b<-ggplot(data = stock, aes(company ='AAPL' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
c<-ggplot(data = stock, aes(company ='GOOG' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
d<-ggplot(data = stock, aes(company ='META' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
e<-ggplot(data = stock, aes(company ='MSFT' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
f<-ggplot(data = stock, aes(company ='NFLX' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
g<-ggplot(data = stock, aes(company ='TSLA' , y = 'Open')) +
  geom_line(x= 'Volume', y='Close')
...
# Wish I had more time on this one 
...
# The stock to be the least sensitive in 2020 is NFLX with only losing about .5.
# Teslas stock seems to be the most to change in its close price from going to ≈ 5 to ≈ 3.5.
